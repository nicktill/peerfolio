      ...
      <main className="flex-1 relative z-10">
        ...
        <section className="py-24 md:py-32 bg-gradient-to-b from-gray-900 via-gray-800 to-gray-900 relative overflow-hidden">
          ...
          <div className="container relative px-6 max-w-4xl mx-auto text-center">
            ...
            <div className="flex items-center justify-center space-x-4 sm:space-x-8 mb-12 text-sm text-gray-400 animate__animated animate__fadeIn animate__delay-2s">
            ...
            <div className="animate__animated animate__fadeIn animate__delay-3s">
              <Link href="/waitlist">
                <Button
                  size="lg"
                  className="bg-gradient-to-r from-emerald-500 via-emerald-600 to-teal-600 hover:from-emerald-600 hover:via-emerald-700 hover:to-teal-700 text-white hover:text-white font-semibold shadow-xl"
                >
