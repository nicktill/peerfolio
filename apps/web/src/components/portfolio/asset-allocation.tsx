...
export function AssetAllocation({ assetAllocation, formatCurrency }: AssetAllocationProps) {
  return (
    <Card className="relative group/chart overflow-hidden">
      <div className="absolute inset-0 bg-gradient-to-br from-violet-50/30 via-blue-50/20 to-indigo-50/30 dark:from-violet-950/20 dark:via-blue-950/10 dark:to-indigo-950/20 opacity-0 group-hover/chart:opacity-100 transition-opacity duration-700"></div>
      
      <CardHeader className="relative z-10 bg-gradient-to-br from-violet-50/50 to-blue-50/50 dark:from-violet-950/20 dark:to-blue-950/20 border-b border-gray-100 dark:border-gray-800 pb-4">
        ...
        <CardDescription className="text-gray-600 dark:text-gray-300">Portfolio distribution by asset type</CardDescription>
      </CardHeader>
